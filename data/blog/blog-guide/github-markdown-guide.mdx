...
```md
> [!CAUTION]
> This is a cautionary note. Be careful! This might be dangerous.

> [!NOTE]
> This is an informational note.

> [!TIP]
> Here’s a helpful tip for using the product.

> [!WARNING]
> Proceed with caution when making this change.

> [!IMPORTANT]
> Ensure that you back up your data before proceeding.
```
