...
<figure>
  <Image
    src="/static/images/machine-learning/algo.png"
    alt="Traditional Algorithm"
    width={700}
    height={400}
  />
  <figcaption>
    <strong>Fig. 1.</strong> Traditional Algorithm: the patterns or decision logic is hand-crafted.{' '}
  </figcaption>
</figure>
